# 导入必要的库
import torch
from poem_lstm.model import RNNModel
from poem_lstm.poem_data_processing import process_poems
import numpy as np
...
end_token = 'E'
# 模型保存的目录
model_dir = 'poem_lstm/model/'
# 诗歌数据文件路径
poems_file = 'poem_lstm/data/poems.txt'
